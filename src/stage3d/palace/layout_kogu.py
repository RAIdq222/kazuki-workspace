...
WALLS = [
    ...
    # 主殿基壇から左右に伸びる袖塀 (b08_17: 赤壁+橙瓦笠)。±40 に掖門の開口
    dict(id="wall_main_w1", p1=(-110, 160), p2=(-44, 160), h=5.0),
    dict(id="wall_main_w2", p1=(-36, 160), p2=(-32, 160), h=5.0),
    dict(id="wall_main_e1", p1=(32, 160), p2=(36, 160), h=5.0),
    dict(id="wall_main_e2", p1=(44, 160), p2=(110, 160), h=5.0),
    # 前庭と主殿前広場の境 (低め)
...
TREES = [
    ...
    (46, 230, 2.4), (-74, 42, 2.8), (-74, 212, 3.0), (-70, 278, 2.8),  # 池を避ける
