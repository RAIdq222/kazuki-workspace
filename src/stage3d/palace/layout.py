...
FIGURES = [(0, 20), (-6, 60), (0, 100), (4, 104), (14, 170)]

# カメラ: T=俯瞰 / A=b08_01全景の再現角 / F=正殿正対 / P=配置図
CAMS = {
    "T": dict(loc=(-120, -55, 95), look=(0, 150, 0), lens=32),
    "A": dict(loc=(68, 16, 13), look=(-30, 180, 6), lens=26),
    "F": dict(loc=(0, 66, 3.0), look=(0, 124, 12), lens=30),
    "P": dict(loc=(0, 138, 300), look=(0, 138.5, 0), lens=20),
}
